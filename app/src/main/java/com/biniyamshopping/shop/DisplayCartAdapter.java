...
public class DisplayCartAdapter extends RecyclerView.Adapter<DisplayCartAdapter.ImageViewHolder> {
    SqlDatabase db;
    boolean color;
    InterstitialAd ad;
    ...
    public DisplayCartAdapter(Context context, List<Messages> uploads) {
        mContext = context;
        mUploads = uploads;
    }
    ...
    public void onBindViewHolder(@NonNull ImageViewHolder holder, int position) {
        ...
        boolean exist= CartDbService.getInstance(mContext, ObjectBox.get()).existsInCache(cartmessage.getKey());
        if(exist){
